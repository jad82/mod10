...
Telefon.prototype.printInfo = function() { 
	console.log("Marka telefonu to " + this.marka + ", kolor to " + this.kolor + ", a cena to " + this.cena + ", pamięci RAM ma " + this.pamięć + ", bateria wytrzymuje " + this.bateria + " godzin czuwania." ); 
};
